...
- `stl/bear_can_clicker_base.stl` — soda-can body, switch mount and keyring lug
- `stl/bear_can_clicker_top.stl` — bear button with an internal MX cross socket
...
5. Add the split ring through the side lug.
